...
This is possible with the GenerateClasses.bat in the root direcotry of the java mockup.

- Create a small java project
I used Eclipse for this job an create one class with a main function.
