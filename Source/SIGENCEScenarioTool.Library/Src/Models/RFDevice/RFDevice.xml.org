...
<RFDevice Comment="Represent A Device Based On A Radio Frequency.">
    ...
    <Property Name="Latitude" Type="double" Init="double.NaN" Comment="The Latitude Of The RF Device (WGS84)." />
    <Property Name="Longitude" Type="double" Init="double.NaN" Comment="The Longitude Of The RF Device (WGS84)." />
    <Property Name="Altitude" Type="uint" Init="0" Comment="The Elevation Of The RF Device Above The Sea Level (Meter)." />
    ...
    <Property Name="RxTxType" Type="RxTxType" Init="RxTxType.Unknown" Comment="For All Receivers (i.e. ID’s &lt; 0) This Parameter Defines The Radio Being Used." />
    ...
    <Property Name="CenterFrequency_Hz" Type="ulong" Init="0" Comment="For Transmitters (I.E. Id’s >= 0) This Parameter Defines Transmitter Signal Center Frequency [Hz]. For Receivers (I.E. Id’s &lt; 0) This Parameter Is Currently Unused." />
    <Property Name="Bandwith_Hz" Type="uint" Init="0" Comment="The Bandwith Of The Transmitter." />
    <Property Name="Gain_dB" Type="int" Init="0" Comment="For Transmitters (I.E. Id’s >= 0) This Parameter Defines Transmitter Signal Power [Dbm]. For Receivers (I.E. Id’s &lt; 0) This Parameter Is Currently Unused." />
    <Property Name="SignalToNoiseRatio_dB" Type="uint" Init="0" Comment="For Receivers (I.E. Id’s &lt; 0) This Parameter Is Imposes Gaussian White Noise To The Respective Receiver Signal. For Transmitters (I.E. Id’s >= 0) This Parameter Is Unused." />
