    ...
    static public class XElementExtension
    {
        ...
        static public T GetProperty<T>( this XElement eParent , string strElementName , T tDefault )
        {
            ...
            if( t == typeof( Latitude ) )
            {
                ...
                return ( T ) ( ( object ) new Latitude( GetDoubleFromNodeComma( eParent , strElementName ) ?? xDefault ) );
                //return ( T ) ( ( object ) ( GetDoubleFromNodePoint( eParent , strElementName ) ?? xDefault ) );
            }
            ...
            if( t == typeof( Longitude ) )
            {
                ...
                return ( T ) ( ( object ) new Longitude( GetDoubleFromNodeComma( eParent , strElementName ) ?? xDefault ) );
                //return ( T ) ( ( object ) ( GetDoubleFromNodePoint( eParent , strElementName ) ?? xDefault ) );
            }
