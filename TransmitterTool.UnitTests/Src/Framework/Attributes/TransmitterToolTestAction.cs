...
namespace TransmitterTool.UnitTest.Attributes
{
    ...
    /// 
    /// </summary>
    sealed public class TransmitterToolTestAction : Attribute, ITestAction
    {
        /// <summary>
        /// Logger zum Ausgeben der Protokollierung.
        /// </summary>
        static private readonly ILog Log = LogManager.GetLogger(typeof(TransmitterToolTestAction));
    ...
    } // end sealed public class TransmitterToolTestAction
}
