# RFDevice.DEFAULT_REMARK Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Shared ReadOnly DEFAULT_REMARK As String
```

**C++**<br />
``` C++
public:
static initonly String^ DEFAULT_REMARK
```

**F#**<br />
``` F#
static val DEFAULT_REMARK: string
```
