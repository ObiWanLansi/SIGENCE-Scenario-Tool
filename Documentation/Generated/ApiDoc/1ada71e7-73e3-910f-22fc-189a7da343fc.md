# XElementExtension.GetBoolFromNode Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static Nullable<bool> GetBoolFromNode(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetBoolFromNode ( 
...
public:
[ExtensionAttribute]
static Nullable<bool> GetBoolFromNode(
...
``` F#
[<ExtensionAttribute>]
static member GetBoolFromNode : 
        xCurrentElement : XElement * 
        strElementName : string -> Nullable<bool> 
