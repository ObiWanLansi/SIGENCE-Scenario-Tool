# RFDevice.XPOS Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Const XPOS As String = "XPos"
```

**C++**<br />
``` C++
public:
literal String^ XPOS = "XPos"
```

**F#**<br />
``` F#
static val mutable XPOS: string
```
