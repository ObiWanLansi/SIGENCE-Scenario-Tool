# XElementExtension.GetSingleFromNodeComma Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static Nullable<float> GetSingleFromNodeComma(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetSingleFromNodeComma ( 
...
public:
[ExtensionAttribute]
static Nullable<float> GetSingleFromNodeComma(
...
``` F#
[<ExtensionAttribute>]
static member GetSingleFromNodeComma : 
