# RFDevice.ROLL Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Const ROLL As String = "Roll"
```

**C++**<br />
``` C++
public:
literal String^ ROLL = "Roll"
```

**F#**<br />
``` F#
static val mutable ROLL: string
```
