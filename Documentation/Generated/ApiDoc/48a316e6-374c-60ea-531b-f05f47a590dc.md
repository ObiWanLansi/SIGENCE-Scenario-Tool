# Tool.ALLPANGRAMS Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static readonly List<string> ALLPANGRAMS
```

**VB**<br />
``` VB
Public Shared ReadOnly ALLPANGRAMS As List(Of String)
```

**C++**<br />
``` C++
public:
static initonly List<String^>^ ALLPANGRAMS
```

**F#**<br />
``` F#
static val ALLPANGRAMS: List<string>
```
