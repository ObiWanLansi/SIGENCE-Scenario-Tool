# Tool.WILFRIED Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static readonly string WILFRIED
```

**VB**<br />
``` VB
Public Shared ReadOnly WILFRIED As String
```

**C++**<br />
``` C++
public:
static initonly String^ WILFRIED
```

**F#**<br />
``` F#
static val WILFRIED: string
```
