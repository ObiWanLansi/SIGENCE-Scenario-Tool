# RFDevice.DEFAULT_YAW Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static readonly double DEFAULT_YAW
```

**VB**<br />
``` VB
Public Shared ReadOnly DEFAULT_YAW As Double
```

**C++**<br />
``` C++
public:
static initonly double DEFAULT_YAW
```

**F#**<br />
``` F#
static val DEFAULT_YAW: float
```
