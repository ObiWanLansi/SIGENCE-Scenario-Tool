# GeoLocalizationResult.PrimaryKey Property <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Property PrimaryKey As Guid
	Get
	Set
```
...
**F#**<br />
``` F#
member PrimaryKey : Guid with get, set
