# DateTimeExtension.Fmt_YYYYMMDD_HHMMSS Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
``` VB
<ExtensionAttribute>
Public Shared Function Fmt_YYYYMMDD_HHMMSS ( 
	dt As DateTime
) As String
```
...
public:
[ExtensionAttribute]
static String^ Fmt_YYYYMMDD_HHMMSS(
	DateTime dt
)
```
...
``` F#
[<ExtensionAttribute>]
static member Fmt_YYYYMMDD_HHMMSS : 
        dt : DateTime -> string 
