# RFDeviceExtensions.WithCenterFrequency_Hz Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static RFDevice WithCenterFrequency_Hz(
...
``` VB
<ExtensionAttribute>
Public Shared Function WithCenterFrequency_Hz ( 
...
public:
[ExtensionAttribute]
static RFDevice^ WithCenterFrequency_Hz(
	RFDevice^ instance, 
	Frequency^ value
)
```
...
``` F#
[<ExtensionAttribute>]
static member WithCenterFrequency_Hz : 
        instance : RFDevice * 
        value : Frequency -> RFDevice 

```


#### Parameters
&nbsp;<dl><dt>instance</dt><dd>Type: <a href="a824a6f0-dedb-4d3f-8139-8c48872258ae.md">SIGENCEScenarioTool.Models.RFDevice</a><br /></dd><dt>value</dt><dd>Type: <a href="07babace-025c-1c92-df52-7b514b2fb6c8.md">SIGENCEScenarioTool.Datatypes.Physically.Frequency</a><br /></dd></dl>
