# GeoLocalizationResult.DEFAULT_ID Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static readonly int DEFAULT_ID
```

**VB**<br />
``` VB
Public Shared ReadOnly DEFAULT_ID As Integer
```

**C++**<br />
``` C++
public:
static initonly int DEFAULT_ID
```

**F#**<br />
``` F#
static val DEFAULT_ID: int
```
