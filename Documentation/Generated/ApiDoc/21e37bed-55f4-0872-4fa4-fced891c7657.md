# XElementExtension.GetUInt32FromNode Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static Nullable<uint> GetUInt32FromNode(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetUInt32FromNode ( 
...
public:
[ExtensionAttribute]
static Nullable<unsigned int> GetUInt32FromNode(
...
``` F#
[<ExtensionAttribute>]
static member GetUInt32FromNode : 
        xCurrentElement : XElement * 
        strElementName : string -> Nullable<uint32> 
