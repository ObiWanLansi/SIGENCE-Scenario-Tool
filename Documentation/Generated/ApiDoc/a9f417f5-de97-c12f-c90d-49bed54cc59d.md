# IDataReaderExtension.GetInt64OrNull Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static Nullable<long> GetInt64OrNull(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetInt64OrNull ( 
...
public:
[ExtensionAttribute]
static Nullable<long long> GetInt64OrNull(
...
``` F#
[<ExtensionAttribute>]
static member GetInt64OrNull : 
        dbResult : IDataReader * 
        iColumnIndex : int -> Nullable<int64> 
