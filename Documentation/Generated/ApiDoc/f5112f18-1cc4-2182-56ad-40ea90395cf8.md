# RFDevice.GAIN_DB Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Const GAIN_DB As String = "Gain_dB"
```

**C++**<br />
``` C++
public:
literal String^ GAIN_DB = "Gain_dB"
```

**F#**<br />
``` F#
static val mutable GAIN_DB: string
```
