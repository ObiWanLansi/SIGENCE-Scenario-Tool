# UnitPrefixs.Tera Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static readonly UnitPrefix Tera
```

**VB**<br />
``` VB
Public Shared ReadOnly Tera As UnitPrefix
```

**C++**<br />
``` C++
public:
static initonly UnitPrefix^ Tera
```

**F#**<br />
``` F#
static val Tera: UnitPrefix
```
