# IDataReaderExtension.GetGeometryFromWKB Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static IGeometry GetGeometryFromWKB(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetGeometryFromWKB ( 
...
public:
[ExtensionAttribute]
static IGeometry^ GetGeometryFromWKB(
...
``` F#
[<ExtensionAttribute>]
static member GetGeometryFromWKB : 
        dbResult : IDataReader * 
        iColumnIndex : int -> IGeometry 
