# GeoLocalizationResult.DEFAULT_LONGITUDE Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static readonly double DEFAULT_LONGITUDE
```

**VB**<br />
``` VB
Public Shared ReadOnly DEFAULT_LONGITUDE As Double
```

**C++**<br />
``` C++
public:
static initonly double DEFAULT_LONGITUDE
```

**F#**<br />
``` F#
static val DEFAULT_LONGITUDE: float
```
