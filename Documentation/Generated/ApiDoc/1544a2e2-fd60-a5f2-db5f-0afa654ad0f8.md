# RFDevice.BANDWIDTH_HZ Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Const BANDWIDTH_HZ As String = "Bandwidth_Hz"
```

**C++**<br />
``` C++
public:
literal String^ BANDWIDTH_HZ = "Bandwidth_Hz"
```

**F#**<br />
``` F#
static val mutable BANDWIDTH_HZ: string
```
