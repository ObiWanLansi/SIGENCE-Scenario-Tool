# XElementExtension.GetDoubleFromNodePoint Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static Nullable<double> GetDoubleFromNodePoint(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetDoubleFromNodePoint ( 
...
public:
[ExtensionAttribute]
static Nullable<double> GetDoubleFromNodePoint(
...
``` F#
[<ExtensionAttribute>]
static member GetDoubleFromNodePoint : 
