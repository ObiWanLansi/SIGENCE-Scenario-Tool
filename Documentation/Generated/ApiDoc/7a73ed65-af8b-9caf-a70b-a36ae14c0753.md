# XElementExtension.GetDoubleFromNode Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static Nullable<double> GetDoubleFromNode(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetDoubleFromNode ( 
...
public:
[ExtensionAttribute]
static Nullable<double> GetDoubleFromNode(
...
``` F#
[<ExtensionAttribute>]
static member GetDoubleFromNode : 
