# XElementExtension.GetDateTimeFromNodeUTC Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static Nullable<DateTime> GetDateTimeFromNodeUTC(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetDateTimeFromNodeUTC ( 
...
public:
[ExtensionAttribute]
static Nullable<DateTime> GetDateTimeFromNodeUTC(
...
``` F#
[<ExtensionAttribute>]
static member GetDateTimeFromNodeUTC : 
        xCurrentElement : XElement * 
        strElementName : string -> Nullable<DateTime> 
