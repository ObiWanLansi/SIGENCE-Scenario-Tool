# XElementExtension.GetStringFromCData Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static string GetStringFromCData(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetStringFromCData ( 
...
public:
[ExtensionAttribute]
static String^ GetStringFromCData(
...
``` F#
[<ExtensionAttribute>]
static member GetStringFromCData : 
...
#### Parameters
&nbsp;<dl><dt>xCurrentElement</dt><dd>Type: <a href="http://msdn2.microsoft.com/en-us/library/bb340098" target="_blank">System.Xml.Linq.XElement</a><br /></dd><dt>strElementName</dt><dd>Type: <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">System.String</a><br /></dd></dl>
