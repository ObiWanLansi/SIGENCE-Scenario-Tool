# RFDeviceExtensions.WithAntennaType Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static RFDevice WithAntennaType(
...
``` VB
<ExtensionAttribute>
Public Shared Function WithAntennaType ( 
	instance As RFDevice,
	value As AntennaType
) As RFDevice
```
...
public:
[ExtensionAttribute]
static RFDevice^ WithAntennaType(
	RFDevice^ instance, 
	AntennaType value
)
```
...
``` F#
[<ExtensionAttribute>]
static member WithAntennaType : 
        instance : RFDevice * 
        value : AntennaType -> RFDevice 

```


#### Parameters
&nbsp;<dl><dt>instance</dt><dd>Type: <a href="a824a6f0-dedb-4d3f-8139-8c48872258ae.md">SIGENCEScenarioTool.Models.RFDevice</a><br /></dd><dt>value</dt><dd>Type: <a href="bb5d7c7d-c86e-052b-63c1-25315ab2f9c8.md">SIGENCEScenarioTool.Models.AntennaType</a><br /></dd></dl>
