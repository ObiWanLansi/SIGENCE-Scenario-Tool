# XElementExtension.GetInt32FromNode Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static Nullable<int> GetInt32FromNode(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetInt32FromNode ( 
...
public:
[ExtensionAttribute]
static Nullable<int> GetInt32FromNode(
...
``` F#
[<ExtensionAttribute>]
static member GetInt32FromNode : 
        xCurrentElement : XElement * 
        strElementName : string -> Nullable<int> 
