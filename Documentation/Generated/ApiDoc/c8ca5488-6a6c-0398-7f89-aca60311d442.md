# RFDevice.DEFAULT_ROLL Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static readonly double DEFAULT_ROLL
```

**VB**<br />
``` VB
Public Shared ReadOnly DEFAULT_ROLL As Double
```

**C++**<br />
``` C++
public:
static initonly double DEFAULT_ROLL
```

**F#**<br />
``` F#
static val DEFAULT_ROLL: float
```
