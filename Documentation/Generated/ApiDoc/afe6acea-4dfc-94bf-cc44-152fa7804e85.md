# DateTimeExtension.Fmt_DD_MM_YYYY_HH_MM Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static string Fmt_DD_MM_YYYY_HH_MM(
	this DateTime dt
)
```
...
``` VB
<ExtensionAttribute>
Public Shared Function Fmt_DD_MM_YYYY_HH_MM ( 
	dt As DateTime
) As String
```
...
public:
[ExtensionAttribute]
static String^ Fmt_DD_MM_YYYY_HH_MM(
	DateTime dt
)
```
...
``` F#
[<ExtensionAttribute>]
static member Fmt_DD_MM_YYYY_HH_MM : 
        dt : DateTime -> string 
