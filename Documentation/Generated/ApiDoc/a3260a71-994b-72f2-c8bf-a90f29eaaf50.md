# RFDevice.ANTENNATYPE Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Const ANTENNATYPE As String = "AntennaType"
```

**C++**<br />
``` C++
public:
literal String^ ANTENNATYPE = "AntennaType"
```

**F#**<br />
``` F#
static val mutable ANTENNATYPE: string
```
