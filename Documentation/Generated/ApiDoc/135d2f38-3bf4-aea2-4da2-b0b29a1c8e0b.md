# DateTimeExtension.Fmt_YYYYMMDDHHMMSS Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
``` VB
<ExtensionAttribute>
Public Shared Function Fmt_YYYYMMDDHHMMSS ( 
	dt As DateTime
) As String
```
...
public:
[ExtensionAttribute]
static String^ Fmt_YYYYMMDDHHMMSS(
	DateTime dt
)
```
...
``` F#
[<ExtensionAttribute>]
static member Fmt_YYYYMMDDHHMMSS : 
        dt : DateTime -> string 
