# RFDevice.RXTXTYPE Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Const RXTXTYPE As String = "RxTxType"
```

**C++**<br />
``` C++
public:
literal String^ RXTXTYPE = "RxTxType"
```

**F#**<br />
``` F#
static val mutable RXTXTYPE: string
```
