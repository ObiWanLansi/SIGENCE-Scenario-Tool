# RFDeviceExtensions.WithPitch Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static RFDevice WithPitch(
...
``` VB
<ExtensionAttribute>
Public Shared Function WithPitch ( 
