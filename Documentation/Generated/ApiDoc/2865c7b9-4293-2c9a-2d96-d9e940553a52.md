# RandomExtension.NextLong Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
``` VB
<ExtensionAttribute>
Public Shared Function NextLong ( 
	r As Random
) As Long
```
