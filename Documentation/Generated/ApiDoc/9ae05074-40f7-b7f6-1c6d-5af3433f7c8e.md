# XElementExtension.GetDoubleFromNodeComma Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static Nullable<double> GetDoubleFromNodeComma(
...
``` VB
<ExtensionAttribute>
Public Shared Function GetDoubleFromNodeComma ( 
...
public:
[ExtensionAttribute]
static Nullable<double> GetDoubleFromNodeComma(
...
``` F#
[<ExtensionAttribute>]
static member GetDoubleFromNodeComma : 
        xCurrentElement : XElement * 
        strElementName : string -> Nullable<float> 
