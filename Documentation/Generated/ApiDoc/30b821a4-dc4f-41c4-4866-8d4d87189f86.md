# RFDevice.YPOS Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Const YPOS As String = "YPos"
```

**C++**<br />
``` C++
public:
literal String^ YPOS = "YPos"
```

**F#**<br />
``` F#
static val mutable YPOS: string
```
