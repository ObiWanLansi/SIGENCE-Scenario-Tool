# UnitPrefixs.Default Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static readonly UnitPrefix Default
```

**VB**<br />
``` VB
Public Shared ReadOnly Default As UnitPrefix
```

**C++**<br />
``` C++
public:
static initonly UnitPrefix^ Default
```

**F#**<br />
``` F#
static val Default: UnitPrefix
```
