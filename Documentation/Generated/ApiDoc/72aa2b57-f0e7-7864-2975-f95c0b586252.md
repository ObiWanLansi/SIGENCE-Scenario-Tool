# RFDevice.PITCH Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
``` C++
public:
literal String^ PITCH = "Pitch"
```

**F#**<br />
``` F#
static val mutable PITCH: string
```
