# UnitPrefixs.Exa Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**C#**<br />
``` C#
public static readonly UnitPrefix Exa
```

**VB**<br />
``` VB
Public Shared ReadOnly Exa As UnitPrefix
```

**C++**<br />
``` C++
public:
static initonly UnitPrefix^ Exa
```

**F#**<br />
``` F#
static val Exa: UnitPrefix
```
