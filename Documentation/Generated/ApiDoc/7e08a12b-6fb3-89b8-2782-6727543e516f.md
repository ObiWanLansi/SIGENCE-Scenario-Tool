# StringExtension.IsNotEmpty Method <a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
``` VB
<ExtensionAttribute>
Public Shared Function IsNotEmpty ( 
...
static member IsNotEmpty : 
        strContent : string -> bool 

```


#### Parameters
&nbsp;<dl><dt>strContent</dt><dd>Type: <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">System.String</a><br /></dd></dl>
