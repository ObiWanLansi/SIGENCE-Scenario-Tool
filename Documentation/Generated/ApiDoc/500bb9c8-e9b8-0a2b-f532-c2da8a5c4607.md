# RFDevice.DEFAULT_NAME Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Shared ReadOnly DEFAULT_NAME As String
```

**C++**<br />
``` C++
public:
static initonly String^ DEFAULT_NAME
```

**F#**<br />
``` F#
static val DEFAULT_NAME: string
```
