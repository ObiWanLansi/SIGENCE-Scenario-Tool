# GeoLocalizationResult.LOCALIZATIONTIME Field<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_
...
**VB**<br />
``` VB
Public Const LOCALIZATIONTIME As String = "LocalizationTime"
```

**C++**<br />
``` C++
public:
literal String^ LOCALIZATIONTIME = "LocalizationTime"
```

**F#**<br />
``` F#
static val mutable LOCALIZATIONTIME: string
```
