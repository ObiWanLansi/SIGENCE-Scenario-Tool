# GeoLocalizationResultList Class<a href="https://github.com/ObiWanLansi/SIGENCE-Scenario-Tool">SIGENCE Scenario Tool Library Home</a> _**\[This is preliminary documentation and is subject to change.\]**_




## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="http://msdn2.microsoft.com/en-us/library/6sh2ey19" target="_blank">System.Collections.Generic.List</a>(<a href="293bf539-304f-e29d-16b6-063d8b161675.md">GeoLocalizationResult</a>)<br />&nbsp;&nbsp;&nbsp;&nbsp;SIGENCEScenarioTool.Models.GeoLocalizationResultList<br />
...
**VB**<br />
``` VB
Public NotInheritable Class GeoLocalizationResultList
	Inherits List(Of GeoLocalizationResult)
```

**C++**<br />
``` C++
public ref class GeoLocalizationResultList sealed : public List<GeoLocalizationResult^>
```

**F#**<br />
``` F#
[<SealedAttribute>]
type GeoLocalizationResultList =  
    class
        inherit List<GeoLocalizationResult>
    end
```

The GeoLocalizationResultList type exposes the following members.
...
Initializes a new instance of the GeoLocalizationResultList class.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="b9c8d75d-cf4f-ddeb-9088-bbd6b62a9b59.md">GeoLocalizationResultList(Int32)</a></td><td>
Initializes a new instance of the GeoLocalizationResultList class.</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="2680f63c-9375-00a5-b1a3-fce77c8ea620.md">GeoLocalizationResultList(IEnumerable(GeoLocalizationResult))</a></td><td>
Initializes a new instance of the GeoLocalizationResultList class.</td></tr></table>&nbsp;
<a href="#geolocalizationresultlist-class">Back to Top</a>
